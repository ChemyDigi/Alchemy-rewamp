...
export default function BlogHero({ posts }: BlogHeroProps) {
  ...
  return (
    <section className="min-h-screen w-full bg-white overflow-hidden">
      <div className="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col justify-between pl-12 pt-16 pb-10 md:pl-1 lg:flex-row lg:items-center lg:pt-12 lg:pb-14">
        {/* Left side - Text content */}
        <div className="z-10 my-auto max-w-[620px] pb-8 lg:pb-2 max-sm:mt-0 max-sm:pt-12">
        ...
        <div className="relative mt-8 shrink-0 sm:mt-0 lg:mt-0 sm:my-auto lg:my-0 max-sm:ml-auto max-sm:translate-x-1">
          <div
            className="relative"
            style={{
