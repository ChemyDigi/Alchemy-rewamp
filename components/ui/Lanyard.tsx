...
function Band({
  ...
  return (
    <>
      {/* All RigidBodies positioned in world space with offset baked in */}
      <RigidBody
        ref={fixed}
        {...segmentProps}
        type={"fixed" as RigidBodyProps["type"]}
        position={[ox, 5.2 + oy, oz]}
      />

      <RigidBody
        ref={j1}
        {...segmentProps}
        position={[ox + 0.5, 5.2 + oy, oz]}
      >
