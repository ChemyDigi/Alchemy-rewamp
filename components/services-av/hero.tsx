      ...
      >
        ...
        <div className="z-10 text-center lg:text-left mt-6 sm:mt-8 md:mt-12 lg:mt-16">
          ...
          <Link href="/contactus" className="flex justify-center lg:justify-start">
            <button className="group mt-8 mx-auto lg:mx-0 bg-orange text-white h-[56px] pl-8 pr-8 rounded-full relative flex items-center overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-black min-w-[200px] hover:min-w-[260px] active:scale-[0.97] active:duration-75">
